...
export default function RegisterPage() {
  ...
  return (
    <>
      ...
      <section className="absolute w-full h-full sm:bg-gray-100 font-medium text-sm sm:mt-0 dark:bg-gray-900">
        <Toaster />
        <div className="sm:container mx-auto px-4 h-full">
          <div className="sm:flex content-center items-center justify-center h-full">
            <div className="-full sm:w-8/12 md:w-7/12 lg:w-5/12 xl:w-2/7 sm:px-4">
              <div className="sm:flex flex-col min-w-0 break-words w-full mb-6 sm:rounded-sm bg-white sm:border sm:border-gray-300 dark:bg-gray-800 dark:border-gray-700">
